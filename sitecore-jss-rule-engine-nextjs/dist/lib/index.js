...
var PersonalizationHelper = /** @class */ (function () {
    ...
    PersonalizationHelper.prototype.runRuleActions = function (ruleEngine, props, personalizationRule, ruleActions) {
        ...
        var _d, _e, _f, _g, _h;
        return __awaiter(this, void 0, void 0, function () {
            var placeholdersLayout, ruleEngineContext, parsedRule, placeholderPersonalizationsKeys, _j, placeholderPersonalizationsKeys_1, placeholderPersonalizationsKeys_1_1, phName, placeholderPersonalization, placeholderRenderings, personalizedRenderings, e_2_1;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 1:
                        ...
                        _j = true, placeholderPersonalizationsKeys_1 = __asyncValues(placeholderPersonalizationsKeys);
                        _k.label = 2;
                    case 2: return [4 /*yield*/, placeholderPersonalizationsKeys_1.next()];
                    case 3:
                        if (!(placeholderPersonalizationsKeys_1_1 = _k.sent(), _a = placeholderPersonalizationsKeys_1_1.done, !_a)) return [3 /*break*/, 6];
                    ...
                    case 8:
                        ...
                        if (!(!_j && !_a && (_b = placeholderPersonalizationsKeys_1.return))) return [3 /*break*/, 10];
