...
var RulesPersonalizationPlugin = /** @class */ (function () {
    function RulesPersonalizationPlugin(endpointUrl, sitecoreApiKey, ruleEngine) {
        this.order = 3;
    ...
    RulesPersonalizationPlugin.prototype.isDisconnectedMode = function (props) {
        var _a;
        var disconnectedMode = ((_a = props.layoutData.sitecore.context.site) === null || _a === void 0 ? void 0 : _a.name) === 'JssDisconnectedLayoutService';
        return disconnectedMode;
    };
    RulesPersonalizationPlugin.prototype.isPageEditing = function (props) {
        var isEditing = props.layoutData.sitecore.context.pageEditing;
        return isEditing;
    };
    RulesPersonalizationPlugin.prototype.exec = function (props, context) {
        return __awaiter(this, void 0, void 0, function () {
            var doRun, routeFields, personalizationRule, personalizeOnEdge, personalizationHelper;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        doRun = !context.preview &&
                        ...
                        if (!(props.layoutData.sitecore.route &&
                            props.layoutData.sitecore.route.fields)) return [3 /*break*/, 2];
                        routeFields = props.layoutData.sitecore.route.fields;
    ...
    return RulesPersonalizationPlugin;
}());
exports.RulesPersonalizationPlugin = RulesPersonalizationPlugin;
